...
import { Card, Container, Stack, Title, Text, Group, Divider, Badge, Progress, Grid } from "@mantine/core";
  ...
  useEffect(() => {
    ...
    if ((!qMeta.timeBest || !qMeta.spaceBest) && question?.id) {
      supabase
        ...
        .then(({ data }) => {
          if (!active) return;
          if (data) setQMeta({ timeBest: normBigO(data.TimeComplexity), spaceBest: normBigO(data.SpaceComplexity) });
        });
    }
    return () => { active = false; };
  }, [question?.id]);
          ...
          <Stack gap="sm">
            ...
            <Grid>
              ...
              <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
                ...
                <Text fw={600}>{summary?.passed ?? 0} of {summary?.total ?? 0}</Text>
              ...
              <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
                <Stack gap="xs" align="center">
                  ...
                  <Group gap="xs" justify="center">
                    <Badge variant="light" color="blue">{safeTime || "N/A"}</Badge>
              ...
              <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
                <Stack gap="xs" align="center">
                  ...
                  <Group gap="xs" justify="center">
                    <Badge variant="light" color="violet">{safeSpace || "N/A"}</Badge>
